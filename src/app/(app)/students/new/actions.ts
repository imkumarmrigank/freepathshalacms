    ...
    result = await tx(async (c) => {
      ...
      const { rows } = await c.query<{ id: number }>(
        `INSERT INTO students (
           ...
           father_name, father_qualification, father_occupation, father_income,
           father_email, father_mobile, father_photo_media_id,
           mother_name, mother_qualification, mother_occupation, mother_income,
           mother_email, mother_mobile, mother_photo_media_id,
           guardian_name, guardian_qualification, guardian_occupation, guardian_income,
           guardian_email, guardian_mobile, guardian_photo_media_id,
        ...
        [enrollmentNo, admissionNo, registrationNo, centerId,
         ...
         s(payload, "father_occupation"), n(payload, "father_income"),
         ...
         s(payload, "mother_occupation"), n(payload, "mother_income"),
         ...
         s(payload, "guardian_occupation"), n(payload, "guardian_income"),
